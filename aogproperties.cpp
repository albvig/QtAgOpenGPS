...
AOGProperty property_setAS_guidanceLookAheadTime("autosteer/guidanceLookAheadTime",1.5);
...
AOGProperty property_setDisplay_isBrightnessOn("display/brightnessOn",false);
...
AOGProperty property_setAS_functionSpeedLimit("autosteer/functionSpeedLimit",12);
...
AOGProperty property_setWindow_gridSize("dialogs/gridSize","400, 400");
AOGProperty property_setWindow_gridLocation("dialogs/gridLocation",QPoint(20, 20));
AOGProperty property_setWindow_isKioskMode("dialogs/isKioskMode",false);
AOGProperty property_setDisplay_isAutoOffAgIO("display/isAutoOffAgIO",true);
AOGProperty property_setWindow_isShutdownComputer("dialogs/isShutdownComputer",false);
...
AOGProperty property_setAS_deadZoneDistance("autosteer/deadZoneDistance",1);
AOGProperty property_setAS_deadZoneHeading("autosteer/deadZoneHeading",10);
AOGProperty property_setMenu_isLightbarNotSteerBar("display/isLightBarNotSteerBar",false);
AOGProperty property_setTool_isDirectionMarkers("tool/isDirectionMarkers",true);
AOGProperty property_setAS_numGuideLines("autosteer/numGuideLines",10);
...
AOGProperty property_setFeature_isBndContourOn("displayFeatures/isBndContourOn",false);
AOGProperty property_setFeature_isRecPathOn("displayFeatures/isRecPathOn",false);
AOGProperty property_setFeature_isABSmoothOn("displayFeatures/isABSmoothOn",false);
AOGProperty property_setFeature_isHideContourOn("displayFeatures/isHideContourOn",false);
AOGProperty property_setFeature_isWebCamOn("displayFeatures/isWebCamOn",false);
AOGProperty property_setFeature_isOffsetFixOn("displayFeatures/isOffsetFixOn",false);
